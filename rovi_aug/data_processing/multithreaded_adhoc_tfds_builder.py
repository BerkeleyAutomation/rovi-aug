"""
Taken directly from the rlds_dataset_mod package, but had to be modified
in order to NOT create any new processes, but rather keep the GPU running here only 
on this process.

In the future, this will be made so that multiple processes can send data into the GPU.
"""
